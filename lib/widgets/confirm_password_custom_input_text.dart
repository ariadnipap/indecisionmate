...
class ConfirmPasswordCustomTextInput extends StatefulWidget {
  ...
  const ConfirmPasswordCustomTextInput({
  ...
  @override
  _ConfirmPasswordCustomTextInputState createState() => _ConfirmPasswordCustomTextInputState();
}

class _ConfirmPasswordCustomTextInputState extends State<ConfirmPasswordCustomTextInput> {
        ...
        children: [
          ...
          Positioned(
            ...
            child: SizedBox(
              width: 280,
              child: Text(
                widget.showError ? 'Passwords do not match.' : '',
                style: TextStyle(
                  color: Colors.red,
                  fontSize: 12,
                ),
